<template>
    <div class="container my-5" style="max-width: 500px">
        ...
        <form v-on:submit.prevent="handleSubmit">
            ...
            <button type="submit" class="btn btn-outline-primary fw-semibold" v-if="isEnabled">Add Product</button>
            <button type="submit" class="btn btn-outline-danger fw-semibold" disabled v-else>Add Product</button>
        </form>
    </div>
</template>
...
onBeforeMount(() => {
    // use the user token to check if the user is already logged in and redirect to course page
